...
const title = 'Nuxt Admin Template'
const description = 'This Nuxt Admin Template, built with Nuxt, Shadcn Vue, and TailwindCSS. It includes a dark mode toggle and is optimized for performance and data efficiency.'
